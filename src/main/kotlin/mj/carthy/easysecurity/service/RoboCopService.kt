...
import mj.carthy.easyutils.helper.makeFrom
...
class RoboCopService(
  ...
  fun consume(record: ConsumerRecord<String, Map<String, String>>): Unit = with(gson.makeFrom<RoboCop>(record)) { consume{ if (!isExist()) save() } }
